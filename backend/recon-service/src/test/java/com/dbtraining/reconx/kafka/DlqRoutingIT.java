...
class DlqRoutingIT {
    ...
    void failingConsumerRoutesToDlq() {
        ...
        producer.publish(TradeEvent.created("TRD-DLQ-1", "{\"status\":\"NEW\"}"));
    ...
    private boolean dlqHas(String tradeRef) {
        ...
        properties.put(JsonDeserializer.VALUE_DEFAULT_TYPE, TradeEvent.class.getName());

        try (var consumer = new org.apache.kafka.clients.consumer.KafkaConsumer<String, TradeEvent>(properties)) {
